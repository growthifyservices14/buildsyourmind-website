  ...
  const contactInfo = [
    {
      icon: FiMail,
      title: 'Email',
      value: 'info@buildsyourmind.in',
      href: 'mailto:info@buildsyourmind.in',
    },
    {
      icon: FiPhone,
      title: 'Phone',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Contact Builds Your Mind for OEM, ODM, bulk orders, distributor or retailer enquiries. Get in touch via email, phone, or WhatsApp." />
      </Helmet>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-600 mb-8">
                For OEM, ODM, bulk orders, distributor or retailer enquiries, please reach out to us through any of the following channels.
              </p>
                ...
                {contactInfo.map((item, index) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 group-hover:text-brand-blue transition-colors">{item.value}</p>
                    </div>
                  </a>
                ))}
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      {...register('enquiry_type', { required: 'Please select enquiry type' })}
                    ...
                    {errors.enquiry_type && (
                      <p className="text-red-500 text-sm mt-1">{errors.enquiry_type.message}</p>
                    )}
                  </div>
